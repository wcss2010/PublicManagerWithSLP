...
namespace PublicManager
{
    ...
    public class MainConfig
    {
        ...
        public static void initConfig()
        {
            ...
            sdDict["国防科技发展综合研"] = new string[] { "国方科技安全问題研究", "美科技封锁动态与应对策略研究", "国防科技重点领域发展战略问題研究", "国防科技发展评估研究", "军控问題研究", "联合作科学技术问題研究" };
            sdDict["军事智能科技发展研究"] = new string[] { "军事智能科技发展评估研究", "智能化战争技术预见", "人工智能安全战略问題研究", "国外智能科技系列译" };
            sdDict["国防关健技术发展研究"] = new string[] { "国防科技重点领域技术发展路线图研究", "关键技术短板瓶颈问研究", "联合作实验技术发展研究" };
            sdDict["国防前沿技术发展研究"] = new string[] { "前沿技术动态发展研", "国防前沿与颠覆性技术清单研究" };
            sdDict["国防基础研究发展研究"] = new string[] { "国防基础研究重大问題研究" };
            sdDict["国防科技扫描预警研究"] = new string[] { "国防科技热点问題研究", "技术监测預警研究", "美国防部现代化优先事項跟踪评估", "外军作战概念关键技术預测分析" };
            sdDict["国防科信息资源开发利用"] = new string[] { "国防科技知识图谱开发", "军事科创意产品开发", "国防科技新概念新名词" };
